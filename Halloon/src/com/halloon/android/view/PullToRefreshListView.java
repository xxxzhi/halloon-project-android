...
import com.halloon.android.widget.HalloonLoadingBar;
...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	private HalloonLoadingBar mRefreshViewProgress;
	...
	private void init(Context context) {
		...
		pullLayout = (RelativeLayout) mRefreshView.findViewById(R.id.pull_layout);
		mRefreshViewText = (TextView) mRefreshView
				.findViewById(R.id.pull_to_refresh_text);
		mRefreshViewImage = (ImageView) mRefreshView
				.findViewById(R.id.pull_to_refresh_image);
		mRefreshViewProgress = (HalloonLoadingBar) mRefreshView
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		mRefreshViewLastUpdated.setText(SettingsManager.getInstance(
				getContext()).getLastUpdateTime());
	}
